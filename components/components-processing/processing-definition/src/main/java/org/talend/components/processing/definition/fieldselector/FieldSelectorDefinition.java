...
public class FieldSelectorDefinition extends AbstractComponentDefinition {

    public static final String NAME = "FieldSelector";

    public FieldSelectorDefinition() {
        super(NAME, ExecutionEngine.BEAM);
    }

    @Override
    public Class<FieldSelectorProperties> getPropertyClass() {
        return FieldSelectorProperties.class;
    }
    ...
    public RuntimeInfo getRuntimeInfo(ExecutionEngine engine, ComponentProperties properties,
        ...
        try {
            return new JarRuntimeInfo(new URL("mvn:org.talend.components/processing-runtime"),
                    ...
                    "org.talend.components.processing.runtime.fieldselector.FieldSelectorRuntime");
