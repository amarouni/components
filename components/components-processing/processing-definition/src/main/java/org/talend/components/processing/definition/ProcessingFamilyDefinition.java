...
public class ProcessingFamilyDefinition extends AbstractComponentFamilyDefinition implements ComponentInstaller {
    ...
    public ProcessingFamilyDefinition() {
        super(NAME,
                // Components
                new AggregateDefinition(), new FilterRowDefinition(), new NormalizeDefinition(), new PythonRowDefinition(),
                new ReplicateDefinition(), new TypeConverterDefinition(), new WindowDefinition()
        );
    }
